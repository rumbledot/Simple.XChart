...
public class RoLRepositoryBkHelper : IRoLRepositoryHelper
{
    ...
    public RoLRepositoryBkHelper(string connectionString, PexelsService pexelService, VerseService verseService)
    {
    ...
    public async Task<Chart> GetChart(int? id)
    {
        ...
        return await connection.Table<Chart>().FirstOrDefaultAsync(x => x.Id == id);
    }
